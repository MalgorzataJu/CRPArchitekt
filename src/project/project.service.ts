...
import {ListProjectSimpleResAll, ListProjectSimpleResArchive, ProjectItemEntity} from "../types";
...
export class ProjectService {
  ...
  async listArchive(): Promise<ListProjectSimpleResArchive>{
